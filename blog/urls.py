...
from .views import home, create_ticket, create_review,\
    follow_users, edit_ticket, reply_to_ticket,\
    delete_followed, delete_ticket, posts, edit_review,\
    delete_review
...
urlpatterns = [
    ...
    path("follower/<int:followed_user_id>/delete", delete_followed,
         name="delete_followed"),
    ...
    path("ticket/<int:ticket_id>/replyToTicket", reply_to_ticket,
         name="reviews_reply_to_ticket"),
